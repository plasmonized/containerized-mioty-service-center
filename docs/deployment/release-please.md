...
![Release PR Beispiel](/release-please-pr.png)

Dieser PR enthält:
- Automatisch berechnete neue Version (z. B. `1.697.0`)
...
#    → VERSION wird automatisch von 1.696 auf 1.697.0 erhöht

# 4. Automatisch:
#    - GitHub Release v1.697.0 wird erstellt
#    - Docker Image ghcr.io/plasmonized/containerized-mioty-service-center:v1.697.0
...
Wenn ein Projekt Release Please einführt:

1. `release-please-config.json` erstellen
2. `.release-please-manifest.json` mit aktueller Version erstellen
3. Workflow `.github/workflows/release-please.yml` erstellen
4. (Optional) Alten Release-Workflow als Legacy-Fallback behalten
5. Release PR reviewen und mergen
